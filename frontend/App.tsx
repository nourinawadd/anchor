...
export type ScreenName =
  | 'Onboarding' | 'SignUp' | 'Login' | 'VerifyEmail' | 'OnboardingScreenTime'
...
const NO_DRAWER:   ScreenName[] = ['Onboarding', 'SignUp', 'Login', 'VerifyEmail', 'OnboardingScreenTime', 'NFCScan', 'ActiveSession', 'SessionComplete'];
