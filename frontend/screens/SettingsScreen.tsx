...
import { View, Text, Switch, TouchableOpacity, StyleSheet, ScrollView, Platform, TextInput, Alert, ActivityIndicator } from 'react-native';
...
const s = StyleSheet.create({
    ...
    taskRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: spacing.sm + 2, borderBottomWidth: 1, borderBottomColor: colors.border, gap: spacing.sm, marginTop: spacing.xs },
    ...
    priorityBadgeTxt: { fontSize: fontSize.xs, fontWeight: '700' },
    deleteBtn: { padding: spacing.xs },
    addForm: { marginTop: spacing.md, gap: spacing.sm },
    taskInput: { borderWidth: 1.5, borderColor: colors.border, borderRadius: radii.md, padding: spacing.md, fontSize: fontSize.md, color: colors.ink, marginBottom: spacing.xs },
    priorityRow: { flexDirection: 'row', gap: spacing.sm },
    priorityChip: { flex: 1, paddingVertical: spacing.sm, alignItems: 'center', borderRadius: radii.full, borderWidth: 1.5, borderColor: colors.border },
    ...
    addTaskTxt: { fontSize: fontSize.sm, fontWeight: '600', color: colors.ink },
});